...
Map<String, dynamic> eventSearchTagsHandler({
  ...
  if (eventName.isNotEmpty) {
    eventName.trim().split(' ').forEach((val) {
      generatePermutations(val).forEach((perm) {
        searchTags[perm] = true;
      });
    });
  ...
  if (catName.isNotEmpty) {
    catName.trim().split(' ').forEach((val) {
      generatePermutations(val).forEach((perm) {
        searchTags[perm] = true;
      });
    });
  ...
  if (subCatName.isNotEmpty) {
    subCatName.trim().split(' ').forEach((val) {
      generatePermutations(val).forEach((perm) {
        searchTags[perm] = true;
      });
    });
...
Map<String, dynamic> orderSearchTagsHandler({
  required String title,
  required String categoryName,
  ...
  if (subCategoryName.isNotEmpty) {
    subCategoryName.trim().split(' ').forEach((val) {
      generatePermutations(val).forEach((perm) {
        searchTags[perm] = true;
      });
    });
